...
cfg.DOMAIN.SOURCE = cfg.DOMAIN.FO # source domain
cfg.DOMAIN.TARGET = cfg.DOMAIN.FU # target domain 
...
cfg.FILES = EasyDict()
cfg.FILES.NAME = f"{cfg.DOMAIN.SOURCE}_to_{cfg.DOMAIN.TARGET}_TEST_{cfg.MODEL.NAME.UDA}"
...
cfg.PATHS.DATAPATHS.CSV_TEST = "/content/Test_256.csv"
